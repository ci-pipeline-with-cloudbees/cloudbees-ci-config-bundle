...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/ci-pipeline-with-cloudbees/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>ci-pipeline-with-cloudbees</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>ci-pipeline-with-cloudbees</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/ci-pipeline-with-cloudbees/pipeline-template-catalog.git</repositoryUrl>
              <traits>
